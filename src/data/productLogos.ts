...
export const partnerLogos = [
  ...
  { id: 'durr-ndt', name: 'DÜRR NDT', url: assetUrl('DUR.jpg') },
  ...
  { id: 'wohler', name: 'WÖHLER', url: assetUrl('WOHLER.jpg') },
  { id: 'johnson-allen', name: 'JOHNSON & ALLEN', url: assetUrl('JOHNSON.jpg') },
  { id: 'echo', name: 'ECHO ultrasonics', url: assetUrl('ECHO.jpg') },
  { id: 'spectro', name: 'SPECTRO-UV', url: assetUrl('Spectro_UV_transparent_logo.avif') },
